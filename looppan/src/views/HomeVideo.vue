<template>
  <div class="header">
    ...
    <input ref="myInput" type="file" id="fileInput" style="display: none" multiple accept="video/*" @change="uploadFile2($event.target.files)" />
    <button type="button" class="btn btn-pull" @click="resetAndUpload">上传视频</button>
