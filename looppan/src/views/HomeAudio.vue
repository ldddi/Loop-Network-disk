<template>
  <div class="header">
    ...
    <input ref="myInput" type="file" id="fileInput" style="display: none" multiple accept="audio/*" @change="uploadFile($event.target.files)" />
  ...
  <FileTable ref="fileTable" :myInput="myInput" :files="files" @rename-file="renameFile" @remove-file-from-files="removeFileFromFiles" @update-files="updateFiles" @get-file-list="getAudioFileList" @pop-files-cache="popFilesCache" />
</template>
